document.addEventListener('DOMContentLoaded', function() {
    ...
    var wmsLayers = [
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:01 Infraestructura Cultural Teatros', displayName: '01 Infraestructura Cultural Teatros' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:02_Bienes_de_interes_cultural', displayName: '02_Bienes_de_interes_cultural' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:03_Indices_de_Cultura_Ciudadana_Localidad_2023', displayName: '03_Indices_de_Cultura_Ciudadana_Localidad_2023' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:Indice_de_Cultura_Ciudadana_Barrios_2023', displayName: 'Indice_de_Cultura_Ciudadana_Barrios_2023' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:04 Consumo Cultural - IDARTES', displayName: '04 Consumo Cultural - IDARTES' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:05 Juntas de acción Comunal', displayName: '05 Juntas de acción Comunal' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:08 Espacios Integración Social - SDIS', displayName: '08 Espacios Integración Social - SDIS' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:09 SDHT Calles mágicas - Piezas urbanas', displayName: '09 SDHT Calles mágicas - Piezas urbanas' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:10 Participantes charlas barriales', displayName: '10 Participantes charlas barriales' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:11 Puntos charlas barriales 2024', displayName: '11 Puntos charlas barriales 2024' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:13 Rutas defensores 2024', displayName: '13 Rutas defensores 2024' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:14 Barrios propuestos Julio', displayName: '14 Barrios propuestos Julio' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:23_Manzanas_del_Cuidado', displayName: '23_Manzanas_del_Cuidado' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:24_Cuadrantes_Policia', displayName: '24_Cuadrantes_Policia' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:25 Parques y zonas verdes', displayName: '25 Parques y zonas verdes' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:33_ Proyectos ejecutados programa Es Cultura Local 2023', displayName: '33_ Proyectos ejecutados programa Es Cultura Local 2023' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:Localidades', displayName: 'Localidades' },
